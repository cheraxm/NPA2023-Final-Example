#######################################################################################
# FirstName/Surname: chutikarn jaikong
# Student ID: 65070053
...
accessToken = "Bearer Yzg3MmUzYmMtOWY2Ny00MTY2LTgwNjgtMjczNzZhNjJhMzJmOGY1MDU2MmItMWQy_P0A1_bc884c7a-820b-497b-8b60-00b4d15ea95d" 
...
# 4. Provide the URL to the Webex Teams messages API, and extract location from the received message.
    ...
    if message.find("/chutikarn") == 0:
        ...
        location = message[len("/chutikarn "):].strip()
...
# 5. Prepare openweather Geocoding APIGetParameters..
        ...
        openweatherGeoAPIGetParameters = {
            "q": location,
            "limit": 1,
            "appid": "d2d64ac6f0de1bfe39faa84e6a0522e3",
        }
